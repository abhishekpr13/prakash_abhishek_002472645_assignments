...
public class Info5001UniversityExample {
    ...
    public static void main(String[] args) {
        ...
        Course course1 = coursecatalog.newCourse("cloud computting", "INFO 6100", 4);
        Course course2 = coursecatalog.newCourse("Carrier Design", "ENCP 6000", 4);
        Course course3 = coursecatalog.newCourse("Data science with python", "INFO 9000", 4);
        Course course4 = coursecatalog.newCourse("Web Design", "INFO 5000", 4);
        Course course5 = coursecatalog.newCourse("DMDD", "INFO 4000", 4);

        CourseSchedule courseschedule = department.newCourseSchedule("Fall2020");

        CourseOffer courseoffer1 = courseschedule.newCourseOffer("INFO 5100");
        CourseOffer courseoffer2 = courseschedule.newCourseOffer("INFO 6100");
        CourseOffer courseoffer3 = courseschedule.newCourseOffer("ENCP 6000");
        ...
        CourseOffer courseoffer8 = courseschedule.newCourseOffer("INFO 9000");
        CourseOffer courseoffer9 = courseschedule.newCourseOffer("ENCP 6000");
        ...
        courseload1.newSeatAssignment(courseoffer1).setGrade(4.0f); // Student 1 registered for courseoffer1
        courseload2.newSeatAssignment(courseoffer2).setGrade(3.9f); // Student 2 registered for courseoffer2
        courseload3.newSeatAssignment(courseoffer3).setGrade(3.8f); // Student 3 registered for courseoffer3
        courseload4.newSeatAssignment(courseoffer4).setGrade(3.7f); // Student 4 registered for courseoffer4
        courseload5.newSeatAssignment(courseoffer5).setGrade(3.6f); // Student 5 registered for courseoffer5
        courseload6.newSeatAssignment(courseoffer6).setGrade(3.5f); // Student 6 registered for courseoffer6
        courseload7.newSeatAssignment(courseoffer7).setGrade(3.4f); // Student 7 registered for courseoffer7
        courseload8.newSeatAssignment(courseoffer8).setGrade(3.3f); // Student 8 registered for courseoffer8
        courseload9.newSeatAssignment(courseoffer9).setGrade(3.2f); // Student 9 registered for courseoffer9
        courseload10.newSeatAssignment(courseoffer10).setGrade(3.1f); // Student 10 registered for courseoffer10
